    ...
    <div className='aboutPage'>
      <MDBContainer className="mt-5 text-justify">
        <MDBRow className='background'>
          <MDBCol id="profileImage" md="3">
            <img src='http://placekitten.com/250/250' className="z-depth-1 rounded-circle" alt='me' height="250px"></img>
          </MDBCol>
          
          <MDBCol md="9" className=" z-depth-1 rounded">

      ...
      <MDBRow className="blog">
        <MDBCol size='6'>
          <MDBRow>
            <MDBCol className="pl1" size='4'>
              <img id="postThumbnail" src="http://placekitten.com/250/200" alt="placeholder" />
            </MDBCol>
            <MDBCol className="pl1" size='4'>
        ...
        <MDBCol className='text-justify' size='6'>    
          <div className="blogPost">
            <h5 id="title"><strong> Post Title </strong></h5>
            <p id="date"> Published on <em>01 Oct 2019</em></p>
            <p id="body">
